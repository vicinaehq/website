...
function WindowsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      <path d="M0 0h11.408v11.408H0zm12.594 0H24v11.408H12.594zM0 12.594h11.408V24H0zm12.594 0H24V24H12.594z" />
    </svg>
  );
}
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="flex items-center justify-center gap-1 mb-3">
        {([
          { id: "linux" as Platform, label: "Linux", icon: <TuxIcon /> },
          { id: "macos" as Platform, label: "macOS", icon: <AppleIcon /> },
          { id: "windows" as Platform, label: "Windows", icon: <WindowsIcon /> },
        ]).map((p) => (
          <button
            key={p.id}
  ...
  return (
    <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute top-[15%] left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full blur-[120px] opacity-60"
          style={{
            background:
              "radial-gradient(ellipse, rgba(184,160,124,0.08) 0%, rgba(184,160,124,0.03) 50%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 text-center">
        <motion.h1
          ...
          className="text-5xl sm:text-6xl lg:text-7xl tracking-tight text-stone-100"
        >
          {siteConfig.name}
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-3 text-lg sm:text-xl text-sand-400"
        >
          {siteConfig.tagline}
        </motion.p>
