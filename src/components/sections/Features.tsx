  ...
  return (
    <section id="features" className="relative overflow-x-clip py-24 sm:py-32">
      ...
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[500px] h-[400px] rounded-full blur-[120px]"
          style={{
            background:
              "radial-gradient(ellipse, rgba(184,160,124,0.05) 0%, transparent 70%)",
          }}
        />
      </div>
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-3 text-stone-400">
            A single interface for everything on your desktop.
          </p>
        </motion.div>
